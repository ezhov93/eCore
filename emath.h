...
static const double HalfPi = 1.5707963267948966192313216916398;
static const double TwoPi = 6.283185307179586476925286766559;
static const double DegToRad = 0.017453292519943295769236907684886;
static const double RadToDeg = 57.29577951306798154814105;
static const double Euler = 2.718281828459045235360287471352;
...
template <typename T>
T constrain(const T amt, const T low, const T high) {
...
template <typename T>
bool inRange(const T amt, const T low, const T high) {
